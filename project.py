...
while el == False:
    ...
    if ch == 1:
        ...
        print('3- To print Each Character As Separate')
        ...
        #Print Each Character as Separate 
        elif ch1==3:
            sep = ' - '.join(s)
            print('Separate Character Of String: ', sep)
    ...
    # Operation On Numbers
        ...
        print('Operation Want To Perform--')
        print('1- Sum  Of Even And Odd Digits Separately')
        print('2- Check Palindrome')
